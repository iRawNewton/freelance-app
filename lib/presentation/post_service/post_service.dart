...
class ServicePost extends StatefulWidget {
  const ServicePost({super.key, required this.userId});
  final String userId;
            ...
            child: Column(
              ...
              children: [
                ...
                CheckoutFormWidget(
                  ...
                  label: 'Service Title',
                  controller: _title,
                  hintText: 'Enter the service title',
                  isImp: true,
                  textInputType: TextInputType.name,
                  maxLines: 1,
                  errorText: 'Please enter the title of the service',
                ),
                ...
                CheckoutFormWidget(
                  width: 1.0,
                  label: 'Service minimum delivery time',
                ...
                CheckoutFormWidget(
                  ...
                  maxLines: 5,
                  errorText: 'Provide description for the service',
                ),
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                CheckoutFormWidget(
                  ...
                  hintText:
                      'List the tools and technologies to be used (optional)',
                  isImp: false,
                  textInputType: TextInputType.multiline,
                  maxLines: 2,
                ),
