...
import 'prod_desc_views.dart';

class ProductPostedView extends StatelessWidget {
  const ProductPostedView({
    super.key,
...
class ProductPostedViewLoading extends StatelessWidget {
  const ProductPostedViewLoading({
    super.key,
  });
